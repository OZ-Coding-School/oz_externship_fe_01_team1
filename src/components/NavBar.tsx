...
export default function NavBar() {
  ...
  return (
    <>
      <div
        className="w-full flex justify-center items-center bg-[#222222] text-[#ffffff] 
              ...
              <div className="absolute top-[100%] right-0 mt-2 bg-white shadow-lg rounded-xl p-4 w-52 text-sm z-50">
                {userInfo && (
                  <>
                    {/* 닉네임 + 이메일 */}
                    <div className="mb-2">
                      <div className="text-[16px] mb-[12px] font-bold">
                        {userInfo?.user.nickname}
                      </div>
                      <div className="text-[13px] mb-[20px] text-gray-400">
                        {userInfo?.user.email}
                      </div>
                    </div>
