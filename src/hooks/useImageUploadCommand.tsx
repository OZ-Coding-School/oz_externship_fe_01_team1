...
import { imageResize as defaultMaxSize } from '@utils/imageresize';

const createBlobURL = (file: File): string => URL.createObjectURL(file);

export const useImageUploadCommand = (
    maxSizeBytes: number = defaultMaxSize
): ICommand => ({
    name: 'image-upload',
    ...
    execute: async (_: TextState, api: TextAreaTextApi) => {
        ...
        input.onchange = () => {
            ...
            if (file.size > maxSizeBytes) {
                ...
                alert(`이미지는 ${mb}MB 이하만 업로드할 수 있습니다.`);
                return;
            }
